// A manually tree shaken version of https://github.com/microsoft/TypeScript-Website/blob/v2/packages/typescript-vfs/src/index.ts
// Also MIT
...
export function createVirtualTypeScriptEnvironment(
  ...
  return {
    ...
    updateFile: (fileName, content, optPrevTextSpan) => {
      ...
      const newText =
        prevFullContents.slice(0, prevTextSpan.start) + content + prevFullContents.slice(prevTextSpan.start + prevTextSpan.length)
...
export const createDefaultMapFromCDN = (
  ...
  cache: boolean,
  ts: TS,
  lzstring?: typeof import("../../web/sandbox/vendor/lzstring.min"),
