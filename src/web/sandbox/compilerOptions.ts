...
import { compressToEncodedURIComponent } from "./vendor/lzstring.min"
 ...
 */
export function getDefaultSandboxCompilerOptions(isJS: boolean, existingConfig: CompilerOptions) {
...
export const createURLQueryWithCompilerOptions = (input: { code: string, originalParams: string, currentCompilerOptions: CompilerOptions, defaultCompilerOptions: CompilerOptions }, paramOverrides?: any): string => {
    ...
    const hash = `code/${compressToEncodedURIComponent(input.code)}`
